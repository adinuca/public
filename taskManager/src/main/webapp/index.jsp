...
<div id="container">
	...
	<div id="content">
			...
			<p>Validation for form fields - don't try to find defects, there are plenty, and I'm aware of them.</p>
			<p>UI changes. Make mind map for tasks, fix buttons and other minor fixes. </p>
			...
			<p>Some small little problems arround get and post( add spring web flow maybe). </p>
			<p>This is all that comes into my mind at the moment, but I will update as soon as I remember something.</p>
			
			
			<h3>Improvements</h3>
			<p>Make the board configurable, people should be able to add their own categories.</p>
			<p>Add alert when removing a task.</p>
			<p>Add spring security.</p>
			<p>Make tasks more visible according to their status and due dates.</p>
			<p>Internationalization.</p>
			<p>Use velocity</p>
			<h2>You can create your own user, please use valid data, or at least some words - not other chars.</h2>
			<table>
            	<tr>
